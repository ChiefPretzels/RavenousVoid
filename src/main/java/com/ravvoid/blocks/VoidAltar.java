...
public class VoidAltar extends Block implements ITileEntityProvider {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        {
            if (Ref.altarListTier1(heldItem, worldIn) != null || ItemStack.areItemsEqual(heldItem, new ItemStack(VoidItems.VOIDORB)) || ItemStack.areItemsEqual(heldItem, new ItemStack(VoidItems.AWAKENEDVOIDORB))) {
